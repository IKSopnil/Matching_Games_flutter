...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const SplashScreen(), // Change the home to SplashScreen
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    Timer(const Duration(seconds: 3), () {
      setState(() {
        showLogo = false; // Hide logo after 3 seconds
      });
    });
  }
    ...
    return Scaffold(
      ...
      body: Center(
        child: AnimatedSwitcher(
          ...
          child: showLogo
              ? Image.asset(
                  'assets/logo.gif', // Path to your logo.gif
                  key: UniqueKey(), // Ensure proper animation when switching
                )
              : MyGame(), // Switch to the main game screen after 3 seconds
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon(Icons.refresh, color: Colors.white), // Set the color to white
